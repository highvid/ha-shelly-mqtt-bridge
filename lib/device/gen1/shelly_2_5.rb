module Device
  module Gen1
    class Shelly25
      ...
      include Publishable
      prepend Components::Gen1::DoubleInput
      ...
      sensor  :energy0, :energy1,
              ...
              state_topic: lambda { |entity|
                "#{Config::BLIGHVID}/#{entity.device.unique_id}/#{entity.unique_id[-1]}/energy"
              },
      ...
      sensor  :power0, :power1,
              ...
              number_type: :to_f,
              state_topic: lambda { |entity|
                "#{Config::BLIGHVID}/#{entity.device.unique_id}/#{entity.unique_id[-1]}/power"
              },
              suggested_display_precision: 2,
      ...
      def update_info(message)
        ...
        @ip_address = json_message[:wifi_sta][:ip]
        @device_id = json_message[:mac]
        @relay0.state = json_message[:relays][0][:ison]
        @relay1.state = json_message[:relays][1][:ison]
      ...
      def post_state_update(entity_name)
        ...
        control_client.update_relay_state(relay.state&.downcase, entity_name[-1])
      end

module Device
  module Gen2
    module OutputSensor
      ...
      SENSOR_OPTIONS = lambda { |device_name, manufacturer_name, index, single = false|
        {
          ...
          listener_topics: [state: "status/switch:#{index}", state_adapter_method: :output_adapter_method],
          manufacturer: manufacturer_name,
          model: device_name,
          name: "Output#{single ? '' : " #{index}"}",
